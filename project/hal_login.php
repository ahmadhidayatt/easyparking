										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
                                                                                                    <a href="hal_forgot.php" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
								</form>
								<form id="register-form" action="proses/register.php" method="post" role="form" style="display: none;">
									<div class="form-group">
									...
									<div class="form-group">
										<input type="password" name="password" id="pass1" tabindex="1" class="form-control" placeholder="Password" value="" required>
									</div>
									<div class="form-group">
