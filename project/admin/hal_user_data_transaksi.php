                                ...
                                <div class="card-body">
                                    ...
                                    <div class="x_content">
                                        <div class="text-right" style="margin-bottom: -30px;">
                                            <a href="hal_user_tambah_transaksi.php" class="btn btn-sm btn-warning">Tambah Trransaksi Baru <i class="fa fa-arrow-circle-right"></i></a>
                                        </div>

                                        <div class="table-responsive m-t-40">
                                            <?php
                                            $tampil = ("select * from tb_transaksi where id_pemilik_kendaraan = '$id' order by id_transaksi desc");
