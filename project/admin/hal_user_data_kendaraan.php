                            ...
                            <div class="card-body">
                                ...
                                <div class="x_content">
                                    <div class="text-right" style="margin-bottom: -30px;">
                                        <a href="hal_user_tambah_kendaraan.php" class="btn btn-sm btn-warning">Tambah kendaraan Baru <i class="fa fa-arrow-circle-right"></i></a>
                                    </div>
                                    
                                <div class="table-responsive m-t-40">
                                    <?php
                                    $tampil = ("select * from tb_kendaraan where id_pemilik_kendaraan = '$id'order by id_kendaraan desc");
                                    ...
                                    <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="10" width="100%">
                                        ...
                                        <tbody>                                           
                                            <?php while ($row = mysqli_fetch_array($result)) {
                                              ...
                                              <td style=""><?php echo $row['nama_kendaraan']; ?></td>
                                               <td style=""><?php echo $row['tipe_kendaraan']; ?></td>
                                              
                                              <td style=""><?php echo $row['plat_nomot']; ?></td>
                                              
                                            
                                              <td style="width: 150px;"><a class="btn btn-sm btn-primary" href="hal_user_edit_kendaraan.php?hal=edit&kd=<?php echo $row['id_kendaraan']; ?>"><i class="fa fa-edit"></i> Edit</a>
