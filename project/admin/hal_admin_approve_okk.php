            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Order Kendaraan</h4>
                                    ...
                                    <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="10" width="100%">
                                        ...
                                        <tbody>                                           
                                            <?php while ($row = mysqli_fetch_array($result)) {
                                              ...
                                              <td style="width: 90px;"><?php echo $row['lokasi_asal']; ?></td>
                                              <td style="width: 120px;"><?php echo $row['kota_tujuan']; ?></td>
                                              <td style="width: 120px;"><?php echo $row['alamat_tujuan']; ?></td>
                                              <td style="width: 150px;"><?php echo $row['tgl_sewa']; ?></td>
                                              
                                              <td style="width: 200px;"><a class="btn btn-sm btn-primary" href="../proses/admin_aprover_order.php?hal=edit&kd=<?php echo $row['id_sewa']; ?>"><i class="fa fa-user-plus"></i> Setujui</a>
                                              <a class="btn btn-sm btn-danger" href="../proses/admin_hapus_sewa.php?hal=hapus&kd=<?php echo $row['id_sewa']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus Pemesan?');"><i class="fa fa-user-times"></i> Tolak</a></td>
                                            </tr>
                                             <?php
                                            }
                                            ?>
