                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <?php
                                    $tampil = ("select * from tb_customer where id_customer='$_GET[kd]'");
                                    ...
                                    <table id="example23" class="display table table-hover table-striped table-bordered" cellspacing="10" width="100%">
                                        ...
                                        <tbody>                                           
                                            <?php while ($row = mysqli_fetch_array($result)) {
                                              ...
                                              <td style="width: 190px;"><?php echo $row['no_ktp']; ?></td>
                                              <td style="width: 90px;"><?php echo $row['email']; ?></td>
                                              <td style="width: 120px;"><?php echo $row['alamat']; ?></td>
                                              <td style="width: 150px;"><?php echo $row['asal_perusahaan']; ?></td>
                                              
                                              <td style="width: 200px;"><a class="btn btn-sm btn-primary" href="../proses/admin_aprover_pemesan.php?hal=edit&kd=<?php echo $row['id_customer']; ?>"><i class="fa fa-user-plus"></i> Setujui</a>
                                              <a class="btn btn-sm btn-danger" href="../proses/admin_hapus_pemesan.php?hal=hapus&kd=<?php echo $row['id_customer']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus Pemesan?');"><i class="fa fa-user-times"></i> Tolak</a></td>
                                            </tr>
                                             <?php
                                            }
                                            ?>
