...
$res = mysqli_query($connect, "SELECT * FROM tb_pemilik_kendaraan WHERE email='$_POST[email]'") or die(mysqli_error($connect));
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%;
            ...
            font-family: sans-serif;" class="header">
                 Pemberitahuan password anda, Harap jaga kerahasiaan anda
        </td>
    </tr>
        ...
        <td align="left" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%;" class="list-item"><table align="center" border="0" cellspacing="0" cellpadding="0" style="width: inherit; margin: 0; padding: 0; border-collapse: collapse; border-spacing: 0;">
            ...
            <tr>
                ...
                <td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
                    ...
                    font-family: sans-serif;" class="paragraph">
                        <b style="color: #333333;">Email </b><br/>
                        ' . $userEmail . '
                </td>
            ...
            <tr>
                ...
                <td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
                    ...
                    color: #000000;
                    font-family: sans-serif;" class="paragraph">
                        <b style="color: #333333;">Nama Pemilik</b><br/>
                        ' . $nama . '
                </td>
            ...
            <tr>
                ...
                <td align="left" valign="top" style="font-size: 17px; font-weight: 400; line-height: 160%; border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
                    ...
                    color: #000000;
                    font-family: sans-serif;" class="paragraph">
                        <b style="color: #333333;"> Password</b><br/>
                        ' . $pass . '
                </td>
...
<!-- End of SECTION / BACKGROUND -->
        ...
        if (!$mail->Send()) {
            ...
            echo "<br/>";
                ...
                echo "<script>alert('Silahkan Cek Email Anda !'); window.location = '../hal_login.php'</script>";
     ...
     echo "<script>alert('Email tidak ditemukan !'); window.location = '../hal_login.php'</script>";
}
?>