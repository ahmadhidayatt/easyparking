...
$res = mysqli_query($connect, "SELECT * FROM tb_pemilik_kendaraan tpk, tb_kendaraan tk WHERE tpk.id_pemilik_kendaraan=tk.id_pemilik_kendaraan and tk.id_kendaraan='$_GET[hal]'") or die(mysqli_error($connect));
...
if ($res && mysqli_num_rows($res) > 0) {
    ...
    try {
        $subject = "Mohon Maaf Pengajuan Anda Kami Tolak";
...
<table border="0" cellpadding="0" cellspacing="0" align="center"
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-bottom: 3px; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 18px; font-weight: 300; line-height: 150%;
            ...
            font-family: sans-serif;" class="subheader">
                Hallo ' . $nama . ' &nbsp;Mohon maaf pengajuan anda belum bisa kami setujui.&nbsp;
        </td>
    </tr>
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
            ...
            color: #000000;
            font-family: sans-serif;" class="paragraph">
                Terima kasih telah melakukan pengajuan kepada kami
        </td>
    </tr>
...
<!-- End of SECTION / BACKGROUND -->
        ...
        if (!$mail->Send()) {
            ...
            $query = ("UPDATE tb_transaksi SET status = 'Tolak' WHERE id_transaksi ='$id_pemesan'");
            $result = mysqli_query($connect, $query)or die(mysqli_error());
            $query_sewa = ("UPDATE tb_sewa_lahan SET status = 'kadaluarsa' WHERE id_transaksi ='$id_pemesan'");
            $result_sewa = mysqli_query($connect, $query_sewa)or die(mysqli_error());
            $query_lahan = ("UPDATE tb_lahan SET kapasitas_tersedia = kapasitas_tersedia+1 WHERE id_lahan ='$id_lahan'");
            $result_lahan = mysqli_query($connect, $query_lahan)or die(mysqli_error());
            $time = date("h:i:sa");
            $date = date("Y/m/d");
            $simpan3 = ("insert into tb_audit (id_audit,tanggal,jam,deskripsi,id_pemilik_lahan)
                     VALUES ('$newIDA '," . "'$date'," . "'$time','Tolak Pengajuan'," . "'$id_pemilik_lahan')");
